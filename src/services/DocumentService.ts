...
export class DocumentService {
  ...
  private async createProcess(processId: string): Promise<InstanceType<typeof ProcessDocument>> {
  ...
  private async createSchoolPeriod(schoolPeriod: SchoolPeriodDtoData, processDoc: any): Promise<InstanceType<typeof SchoolPeriodDocument>> {
  ...
  private async createSubjects(subjects: SubjectDtoData[], processDoc: any) {
    return Promise.all(
  ...
  private async createClasses(classes: ClassDtoData[], processDoc: any) {
    return Promise.all(
  ...
  private async createUsers(users: UserDtoData[], processDoc: any) {
    return Promise.all(
  ...
  private async createEnrollments(enrollments: EnrollmentDtoData[], processDoc: any) {
    return Promise.all(
